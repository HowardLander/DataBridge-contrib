...
public class RenciVectorTest {
  ...
  public void TestRenciVector () throws Exception {
     ...
     try {
         ...
         result = theCosine.compareCollections(collection0, collection0, "question_value");
         ...
         result = theCosine.compareCollections(collection0, collection1, "question_value");
         ...
         result = theHammingDistance.compareCollections(collection0, collection0, "question_value");
         System.out.println("Similarity of collection0 vs collection0: " + result);
         TestCase.assertTrue("Hamming collection0 vs collection0 failed", result == 1.);

         result = theHammingDistance.compareCollections(collection0, collection1, "question_value");
         System.out.println("Similarity of collection0 vs collection1: " + result);
         TestCase.assertTrue("Hamming collection0 vs collection1 failed", result == 0.);

         result = theHammingDistance.compareCollections(collection0, collection2, "question_value");
         ...
         result = theHammingDistance.compareCollections(collection1, collection2, "question_value");
         ...
         result = theNormalizedHammingDistance.compareCollections(collection0, collection0, "question_value");
         System.out.println("Normalized similarity of collection0 vs collection0: " + result + 
             System.lineSeparator());
         TestCase.assertTrue("Hamming collection0 vs collection0 failed", result == 1.);

         result = theNormalizedHammingDistance.compareCollections(collection0, collection1, "question_value");
         ...
         result = theNormalizedHammingDistance.compareCollections(collection0, collection2, "question_value");
         System.out.println("Normalized similarity of collection0 vs collection2: " + result +
            System.lineSeparator());

         result = theNormalizedHammingDistance.compareCollections(collection1, collection2, "question_value");
