...
import org.simmetrics.metrics.TanimotoCoefficient;
 ...
 */
public class RenciTanimotoCoefficient extends RenciSimMeasure {
   ...
   double computeSimilarity(String metaData1, String metaData2) {
      ...
      StringMetric metric = with(new TanimotoCoefficient<String>())
